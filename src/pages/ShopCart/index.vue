<template>
  <div class="cart">
        ...
        <ul class="cart-list" v-for="item in cartList" :key="item.id">
          <li class="cart-list-con1">
            <input
              ...
              @change="changeItemIschecked(item)"
            />
          </li>
          ...
          <li class="cart-list-con7">
            <a href="#none" class="sindelet" @click="deleteOne(item.skuId)"
              >删除</a
            >
            <br />
            <a href="#none">移到收藏</a>
    ...
    <div class="cart-tool">
      ...
      <div class="option">
        <a href="#none" @click="deleteAllItem">删除选中的商品</a>
...
export default {
  ...
  methods: {
    ...
    async deleteOne(id) {
      try {
        await this.$store.dispatch("deleteCarItem", { skuId: id });
        this.$store.dispatch("getCartList");
      } catch (error) {
        alert(error.message);
      }
    ...
    //改变每个item的点击状态
    async changeItemIschecked(item) {
